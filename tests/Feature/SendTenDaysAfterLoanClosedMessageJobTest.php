...
use App\Jobs\SendTenDaysAfterLoanClosedMessage;
use App\Models\{LoanOffer, Customer, Loan};
use Tests\TestCase;

class SendTenDaysAfterLoanClosedMessageJobTest extends TestCase
{
    ...
    public function test_message_sent_after_ten_days_of_loan_closed_was_sent_successfully()
    {
        ...
        (new SendTenDaysAfterLoanClosedMessage([$customer]))->handle();
